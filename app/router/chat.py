...
async def get_player_by_id(request: Request, payload: MessageAuthor) -> List[ChatMessage]:
    return chat_db.get_chat_between_users(user_a=payload.receiverId, user_b=payload.senderId)
